...
namespace Template_P3
{
    ...
    public class ScreenQuad
    {
        ...
        public void Render(Shader shader, int textureID, int colorCubeID)
        {
            ...
            // Bind the colorCube
            int texLoc2 = GL.GetUniformLocation(shader.programID, "colorCube");
            GL.Uniform1(texLoc2, 0);
            GL.ActiveTexture(TextureUnit.Texture0);
            GL.BindTexture(TextureTarget.Texture3D, colorCubeID);
